...
<figure name="f7e3" id="f7e3" class="graf graf--figure graf--layoutOutsetLeft graf-after--p">

<div class="aspectRatioPlaceholder">![](https://cdn-images-1.medium.com/max/600/1*ZLU-gZhzyik3WkM_f8-DVA.png)</div>

<figcaption class="imageCaption">Governance as a Service allows for differentation in markets were the hardware, software, and data have become commoditized.</figcaption>
